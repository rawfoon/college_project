...
const Contacts = () => {
	...
	<form novalidate="" className="space-y-6">
		<div>
			...
			<input id="name" type="text" placeholder="" className="w-full p-3 rounded border-gray-300 border dark:bg-gray-800" />
		</div>
		<div>
			<label for="email" className="text-sm">Email</label>
			<input id="email" type="email" className="w-full p-3 rounded border-gray-300 border dark:bg-gray-800" />
		</div>
		<div>
