...
const Cards = () => {
	...
	<img src="https://www.gdc.gov.bd/midea/featuredimage/featuredimage2023-03-25-17-10-31_641f2b07d57e9.jpg" alt="" className=" object-center mx-auto rounded-[50%] h-72 dark:bg-gray-500" />
	...
	<p className="dark:text-gray-100">Gurudayal Govt. College</p>
            ...
            <div className=" p-6 rounded-xl shadow-xl bg-white dark:bg-gray-900 dark:text-gray-50">
	<img src="https://www.gdc.gov.bd/midea/featuredimage/featuredimage2023-04-02-02-28-20_6428e844c32de.jpg" alt="" className="  object-center mx-auto rounded-[50%] h-72 dark:bg-gray-500" />
	<div className="mt-6 mb-2">
	...
	<p className="dark:text-gray-100">Gurudayal Govt. College</p>
            ...
            <div className=" p-6 rounded-xl shadow-xl bg-white dark:bg-gray-900 dark:text-gray-50">
	<img src="https://i.ibb.co/R3cfBFr/omar-faruk.jpg" alt="" className=" object-center mx-auto rounded-[50%] h-72 dark:bg-gray-500" />
	<div className="mt-6 mb-2">
